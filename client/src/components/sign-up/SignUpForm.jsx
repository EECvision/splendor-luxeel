              ...
              <form onSubmit={this.handleSubmit} className="w-full flex flex-col items-start justify-evenly px-4 md:p-0">
                ...
                <div className="w-full flex flex-col items-center justify-center my-6">
                  ...
                  <div className="w-full p-1 border border-gray-300 rounded bg-blue-200">
                    <button type="button" className="w-full focus:outline-none bg-blue-700 hover:bg-blue-800 text-white text-sm font-medium py-3 focus:outline rounded">CREATE ACCOUNT WITH GMAIL</button>
                  </div>
                </div>
