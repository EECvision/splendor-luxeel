...
const NavDropdownLg = ({ toggle, setToggle, collections }) => {
  return (
    <div className={`${toggle ? "h-96" : "h-0"} w-64 fixed top-0 left-0 z-50 flex-col items-center justify-start bg-white overflow-hidden px-4 mt-16 ml-20 rounded-b-lg shadow`}>
